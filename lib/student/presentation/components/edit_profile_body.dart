...
class EditProfileBody extends StatefulWidget {
  ...
  const EditProfileBody({Key? key, required this.student}) : super(key: key);

  @override
  State<EditProfileBody> createState() => SignUpState();
}

class SignUpState extends State<EditProfileBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AdminBloc, AdminState>(listener: (context, state) {
      ...
      if (state is StudentUpdateOperationSuccess) {
        showDialog(
          context: context,
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(
                              size.height * 0.055, size.height * 0.025, 0, 0),
                          child: Row(
                            children: [
                              Checkbox(
                                side: BorderSide(
                                    ...
                                    if (_fullnamekey
                                      ...
                                      if (_countryKey
                                        ...
                                        if (_fullName !=
                                          ...
                                          setState(() {
                                            print("Errooroororo");
                                            widget.student.fullName = _fullName;
                                          });
                                        }
                                        if (_country !=
                                            widget.student.country) {
                                          setState(() {
                                            widget.student.country = _country;
                                          });
                                        }
                                        if (_classNameKey.currentState!.value !=
                                                null &&
                                          ...
                                          setState(() {
                                            widget.student.classId = _className;
                                          });
                                        }
                                        ...
                                        if (_isChecked == true) {
                                          ...
                                          setState(() {
                                            widget.student.newemail = username!;
                                            widget.student.newpassword =
                                                password!;
                                          });
                                        }
                                        // setState(() {
