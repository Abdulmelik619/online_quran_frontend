...
class UstazSIgnUpBody extends StatefulWidget {
  const UstazSIgnUpBody({Key? key}) : super(key: key);

  @override
  State<UstazSIgnUpBody> createState() => SignUpState();
}

class SignUpState extends State<UstazSIgnUpBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AdminUstazBloc, AdminState>(listener: (context, state) {
      ...
      if (state is UstazAddOperationSuccess) {
        showDialog(
          context: context,
                                  ...
                                  onPressed: () async {
                                    ...
                                    if (_fullnamekey
                                      ...
                                      if (_classNameKey.currentState!.value !=
                                        ...
                                        UstazSignUpModel signUpModel =
                                            UstazSignUpModel.create(
                                          _fullName,
                                          currentUsername,
                                          password!,
                                          _className,
