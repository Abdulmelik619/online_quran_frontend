                    ...
                    body: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            // ignore: prefer_const_constructors
                            Color.fromARGB(255, 51, 49,
                                65), // Darker color on the left side
                            Color.fromARGB(255, 0, 2,
                                7), // Lighter color on the right side
                          ],
                        ),
                      ),
                      child: LayoutBuilder(builder:
                        ...
                        double occupiedHeight =
                            400; // Height of the first container

                        // Calculate the remaining height
                        double remainingHeight = calculateRemainingHeight(
                            constraints, occupiedHeight);
                        return Column(
                      ...
                      children: [
                        ...
                        BottomNavigationBar(
                          ...
                          unselectedLabelStyle: GoogleFonts.poppins(
                            color:
                                true ? Colors.white : const Color(0xff1D1617),
