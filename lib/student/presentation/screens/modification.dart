...
class StudentProfileScreen_2 extends StatefulWidget {
  @override
  _AttendanceScreenState createState() => _AttendanceScreenState();
}

class _AttendanceScreenState extends State<StudentProfileScreen_2> {
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              // ignore: prefer_const_constructors
              Color.fromARGB(255, 51, 49, 65), // Darker color on the left side
              Color.fromARGB(255, 0, 2, 7), // Lighter color on the right side
            ],
          ),
        ),
        child: LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) {
          double occupiedHeight = 250; // Height of the first container
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    CircleAvatar(
                      radius: 50,
                      backgroundImage: NetworkImage("state.student.avatar"),
                    ),
                    SizedBox(height: 10),
                    Text(
                      "Abdulmelik Ambaw",
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        // ignore: prefer_const_constructors
                        Color.fromARGB(
                            255, 18, 3, 27), // Darker color on the left side
                        Color.fromARGB(
                            255, 37, 36, 43), // Lighter color on the right side
                      ],
                    ),
                  ),
                  child: true
                      ...
                      : Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Card(
                                color: Color.fromARGB(255, 40, 39, 49),
                                child: Padding(
